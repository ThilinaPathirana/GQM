...
export class LoginComponent {
  ...
  constructor(
    ...
    private dataService: DataService // private cacheService: CacheAtService, // private themeService: ThemeService,
  ) {
    this.configService
      .getStringConfigVal("buildParams", "version")
      .then((applicationVersion) => {
        this.appVersion = applicationVersion;
      });

    this.configService
      .getStringConfigVal("buildParams", "customization")
      .then((atCustomization) => {
    ...
    this.configService
      .getStringConfigVal("customizationConfigs", "callCenterPhone")
      .then((phone) => {
        this.callCenterNo = phone;
      });

    this.configService
      .getStringConfigVal("customizationConfigs", "callCenterEmail")
      .then((email) => {
